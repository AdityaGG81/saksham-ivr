...
# Config via env vars
COUNSELOR_NUMBER = os.environ.get("COUNSELOR_NUMBER", "+11234567890")
...
def text_for(lang: str, key: str) -> str:
    prompts = {
        ...
        "hi": {
            ...
            "main_menu": "श्वास अभ्यास के लिए 1 दबाएं। ग्राउंडिंग तकनीक के लिए 2 दबाएं। सकारात्मक विचारों के लिये के लिए 3 दबाएं। काउंसलर से जुड़ने के लिए 4 दबाएं। मेन मेनू दोहराने के लिए 9 दबाएं।",
